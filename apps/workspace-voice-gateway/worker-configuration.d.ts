/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 79c7f79def7ca6d9dc1190dfa5fc582b)
// Runtime types generated with workerd@1.20260826.1 2026-08-27 nodejs_compat
interface __BaseEnv_Env {
	VOICE_AUTH: R2Bucket;
	CODEX_RUNTIME_VERSION: "0.150.1";
	SITE_ORIGIN: "https://openassist-daily-workspace.developingadventures.chatgpt.site";
	VOICE_CONTAINER: DurableObjectNamespace<import("./src/index").VoiceContainer>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "VoiceContainer";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CODEX_RUNTIME_VERSION" | "SITE_ORIGIN">> {}
}
