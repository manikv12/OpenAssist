...
interface Window {
  openAssistElectron?: {
    ...
    syncMacSyncPeer: (peerID: string) => Promise<{ ok: boolean; peer?: import("./types").MacSyncPeerStatus; error?: string; pulled?: number; pushed?: number; applied?: number; failedCount?: number; staleCount?: number; conflictCount?: number }>;
    ...
    resetMacSyncPeer: (peerID: string) => Promise<{ ok: boolean; peer?: import("./types").MacSyncPeerStatus; error?: string; pulled?: number; pushed?: number; applied?: number; failedCount?: number; staleCount?: number; conflictCount?: number }>;
    sendMessage: (
      prompt: string,
      threadID?: string,
      pluginIDs?: string[],
