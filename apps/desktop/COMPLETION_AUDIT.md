...
| Do not create chart/chat folders inside Electron folder. | Chart insertion writes markdown into notes; no local chart store. | Verifier rejects `chat`, `conversation`, and chart-store folders under `apps/desktop` | Covered |
