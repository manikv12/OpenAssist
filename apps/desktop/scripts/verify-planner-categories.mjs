...
assert.ok(proxyText.includes('name: "knowledge_planner_categories"'), "realtime must expose knowledge_planner_categories");
assert.ok(proxyText.includes('name: "knowledge_planner_lists"'), "realtime must expose knowledge_planner_lists");
assert.ok(proxyText.includes('name: "knowledge_update_daily_item"'), "realtime must expose knowledge_update_daily_item for planner edits");
assert.ok(proxyText.includes('name: "knowledge_request_tasks_from_note"'), "realtime must expose knowledge_request_tasks_from_note for previewed note-to-task planning");
assert.ok(proxyText.includes("listID") && proxyText.includes("section") && proxyText.includes("tags"), "realtime planner item schemas must accept list, section, and tags");
assert.ok(proxyText.includes("Do not assume business-related tasks are Work"), "realtime instructions must mention business category handling");
...
assert.ok(proxyText.includes("Do not also add Today items to Backlog"), "realtime instructions must keep Today items out of Backlog unless requested");
...
assert.ok(proxyText.includes("Do not use knowledge_request_daily_item for edits"), "realtime instructions must avoid duplicate add-on-edit behavior");
...
assert.ok(proxyText.includes("#Category") && proxyText.includes("@List"), "realtime instructions must document #Category and @List shorthand");
...
assert.ok(proxyText.includes("create tasks from a note") && proxyText.includes("Review Inbox preview"), "realtime instructions must require preview-first note-to-task planning");
